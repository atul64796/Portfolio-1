  ...
  return (
    ...
    >
      <div className="  h-[80vh] w-1/2 max-md:w-full  flex flex-col justify-center items-center gap-15">
        <div className=" autotxt bk flex flex-col justify-center gap-4 pl-32 w-full max-[1380px]:mt-50 max-[480px]:mt-5 flex-wrap max-lg:w-full   max-lg:justify-center max-lg:pl-20  ">
